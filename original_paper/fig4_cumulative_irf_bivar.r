...
load("original_paper_results/bivariate_svar_results.RData")
...
pdf("original_paper_results/fig4_bivar_irf.pdf", width = 5, height = 4.5)
par(mar = c(4, 4, 3, 1))
...
lines(h, y_lo2, lty = 3, lwd = 0.9)
lines(h, y_hi2, lty = 3, lwd = 0.9)
lines(h, y_lo1, lty = 2, lwd = 0.9)
