...
make_figure("rpo", cumulative = FALSE,
            ...
            file = "russian_paper_results/model_3/irf_fig1_rpo.pdf",
            main = "Figure 1. Responses of the Real Price of Crude Oil (Russian Model v3)")

# --- 5. Figure 3: кумулятивный отклик реальных доходностей ----
make_figure("r", cumulative = TRUE,
            ylab = "Cumulative Real Stock Returns (%)",
            file = "russian_paper_results/model_3/irf_fig3_stocks.pdf",
            main = "Figure 3. Cumulative Responses of Russian Real Stock Returns (Russian Model v3)")
