...
titles <- c(
  "Cumulative Effect of Oil Supply Shock on Real Price of Crude Oil (Russian Model v3)",
  "Cumulative Effect of Aggregate Demand Shock on Real Price of Crude Oil (Russian Model v3)",
  "Cumulative Effect of Oil-Market Specific Demand Shock on Real Price of Crude Oil (Russian Model v3)"
)

pdf("russian_paper_results/model_3/fig2_hist_decomp.pdf", width = 8, height = 9)
