...
titles <- c(
  "Cumulative Effect of Oil Supply Shock on Real Price of Crude Oil (Russian Model v1)",
  "Cumulative Effect of Aggregate Demand Shock on Real Price of Crude Oil (Russian Model v1)",
  "Cumulative Effect of Oil-Market Specific Demand Shock on Real Price of Crude Oil (Russian Model v1)"
)
