...
load("russian_paper_results/model_rub/svar_results_without_cur.RData")
...
saveRDS(
  bootstrap_result,
  file = "russian_paper_results/model_rub/recursive_wild_bootstrap_irf_wo_cur.rds"
)
...
make_figure(
  ...
  response = "rpo",
  cumulative = FALSE,
  ylab = "Real price of oil (model without currency)",
  file = "russian_paper_results/model_rub/irf_fig1_rpo_wo_currency.pdf",
  scale = 1
)
...
make_figure(
  ...
  response = "r",
  cumulative = TRUE,
  ylab = "Cumulative Real Stock Returns (%) (model without currency)",
  file = "russian_paper_results/model_rub/irf_fig3_stocks_wo_currency.pdf",
  scale = 1
)
