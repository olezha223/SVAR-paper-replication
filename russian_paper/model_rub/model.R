...
yt <- as.matrix(df[, c("delta_non_rus", "IGREA", "rpo", "rub_diff" ,"ret_t")])
colnames(yt) <- c("delta_prod", "rea", "rpo", "rub_diff", "r")
...
save(
  ...
  model_id,
  supply_source,
  file = "russian_paper_results/model_rub/svar_results.RData"
)
