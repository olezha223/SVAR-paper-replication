...
# варианты consumer_log_return metals_mining_log_return oil_gas_log_return
var_name <- "consumer_log_return" # МЕНЯТЬ ЗДЕСЬ НАЗВАНИЕ ПЕРЕМЕННОЙ
...
var_model <- VAR(yt, p = 12, type = "const")
